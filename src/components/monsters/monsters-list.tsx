...
function MonstersList ({ monsters, className }: MonstersListProps): React.ReactNode {
  if (monsters === null || monsters === undefined || monsters.length === 0) {
    return (
      <div className={mergeClasses('mt-6 sm:mt-8 lg:mt-10 w-full rounded-2xl bg-gradient-to-br from-autumn-cream to-autumn-peach/30 p-8 sm:p-10 lg:p-12 text-center shadow-lg border border-autumn-peach', className)}>
        <h2 className='text-xl sm:text-2xl font-bold text-chestnut-deep mb-2 sm:mb-3'>Tu n&apos;as pas encore de compagnon</h2>
        <p className='text-base sm:text-lg text-chestnut-medium'>Clique sur &quot;Créer une créature&quot; pour lancer ta première adoption magique.</p>
      </div>
    )
  }
